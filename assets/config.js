  ...
  pricing: [
    {
      ...
      features: [
        "추천 대상",
        "복무기간이 50% 충족하신 장병",
        "진로 방향은 대략 정했지만, 구체적인 구직 계획 정리가 필요한 경우",
        "진행 내용",
        "사전 설문을 통한 관심 분야·경험 파악",
        "전역 후 일정에 맞춘 기본 구직·진로 계획 수립",
        "제공 문서",
        "상담 예정 확인서",
        "진로·구직 상담 내용이 정리된 진행 과정 내용서",
        "상담 참여를 증빙하는 수료증(PDF)",
        "기본 증빙서류 준비 가이드",
        "지원",
        "상담 후 추가 문의를 위한 카카오톡 1:1 질의 응답 지원"
      ],
      limitations: [],
      cta: "1일 과정 선택",
      guarantee: ""
    },
    {
      ...
      features: [
        "추천 대상",
        "전역 후 바로 취업·복학·편입을 준비해야 하는 장병",
        "자기소개서/이력서·대학 상담 등 실질 준비까지 함께 진행하고 싶은 경우",
        "진행 내용",
        "자기소개서/이력서 초안 방향성 코칭 또는 대학·자격증 계획 정리",
        "필요 시, 워크넷·대학교·고용24 등을 활용한 구직·상담 방향 설정",
        "제공 문서",
        "상담 예정 확인서",
        "2일간의 상담 내용이 정리된 자세한 진행 과정 보고서",
        "프로그램 참여를 증빙하는 수료증",
        "부대 제출용 기본 서류 가이드",
        "지원",
        "상담 후 추가 문의를 위한 카카오톡 1:1 질의 응답 지원",
